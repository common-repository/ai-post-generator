...
if (!function_exists('ai_post_generator_verify_nonce')){
	function ai_post_generator_verify_nonce() {
		if (!isset($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'], 'ai_post_generator_nonce')) {
			ai_post_generator_return_json(array('exito' => false, 'error' => 'Verificación de nonce fallida.'));
			die();
		}
	}
}
