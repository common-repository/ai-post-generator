...
if (!function_exists('ai_post_generator_add_integration_code_body_buy_tokens')) {
	...
	{
		$get_data = autowriter_callAPI('GET', "https://quiz.autowriter.tech/autowriter_api/get_prices.php", false);
			...
			<div class="tab-pane fade show active" id="pills-tokens" role="tabpanel" aria-labelledby="pills-tokens-tab">
				...
				<div
					...
					<div class="card autowriter-price-card mx-2"
					    ...
					    <a href="https://quiz.autowriter.tech/autowriter_api/checkout_stripe.php?id=<?php echo esc_attr($price['price_id'])?>" class="btn btn-lg w-auto btn-primary mt-2 my-5 d-inline-block"
					        >Upgrade plan</a>
