...
async function ai_post_initialize(price, n_posts) {
  ...
  xmlhttp.open("POST", "https://quiz.autowriter.tech/autowriter_api/single-posts-checkout.php", true);
...
function get_if_sub() {
	...
	xmlhttp.open("POST", "https://quiz.autowriter.tech/autowriter_api/get-new-info.php", true);
