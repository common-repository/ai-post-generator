function ai_cancel_subscription() {
  if (
    ...
    xmlhttp.open(
      "POST",
      "https://quiz.autowriter.tech/autowriter_api/cancel_subscription.php",
      true
    );
...
function ai_edit_settings() {
  ...
  xmlhttp.open("POST", "https://quiz.autowriter.tech/autowriter_api/edit_settings.php", true);
...
jQuery(document).ready(function ($) {
  $(function () {
    function ai_get_settings() {
      ...
      xmlhttp.open(
        "POST",
        "https://quiz.autowriter.tech/autowriter_api/get_settings.php",
        true
      );
