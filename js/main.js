...
function table_of_content(x){
	...
	xmlhttp.open("POST","https://quiz.autowriter.tech/autowriter_api/gpt_scripts/gpt3-create-table.py",true);
...
function do_rich_images(x){
	...
	xmlhttp.open("POST","https://quiz.autowriter.tech/autowriter_api/gpt_scripts/gpt3-rich-image.py",true);
	xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function ai_rewrite(x, type){
	...
	xmlhttp.open("POST","https://quiz.autowriter.tech/autowriter_api/gpt_scripts/gpt3-new-rich.py",true);
	xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function get_images(x, image = false){
	...
	xmlhttp.open("POST","https://quiz.autowriter.tech/autowriter_api/gpt_scripts/gpt3-image-new.py",true);
...
jQuery(document).ready(function($) {
  ...
  $(function() {
	function get_concepts(){
		...
		xmlhttp.open("GET", "https://quiz.autowriter.tech/autowriter_api/get_concepts.php", true);
	...
	function get_titles(){
		...
		var concept_table = "";
		$.ajax({
			url : aiPostGenerator.ajaxurl,
			type: 'POST',
			dataType: 'json',
			data: {
			  action: 'ai_post_generator_get_Posts',
			  nonce: aiPostGenerator.nonce
			},
			success: function(data) {
				...
				xmlhttp.open("GET", "https://quiz.autowriter.tech/autowriter_api/get_posts.php", true);
	...
	function delete_post(post){
		if (confirm("Are you sure you want to delete that post?") == true) {
			$.ajax({
				...
				dataType: 'json',
				data: {
				action: 'ai_post_generator_delete_Post',
				nonce: aiPostGenerator.nonce,
				id: post.id
				},
				success: function(data) {
	...
	function delete_title(id, do_confirm = true){
		...
		xmlhttp.open("POST", "https://quiz.autowriter.tech/autowriter_api/delete_title.php", true);
	...
	$("#ai-add-train").on("click", function() {
		...
		xmlhttp.open("POST", "https://quiz.autowriter.tech/autowriter_api/gpt_scripts/gpt3-contentplan.py", true);
  ...
  function gpt3_all(type){
		...
		xmlhttp.open("POST","https://quiz.autowriter.tech/autowriter_api/gpt_scripts/gpt3-create-post.py",true);
